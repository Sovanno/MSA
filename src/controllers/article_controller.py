...
async def create_article(db: AsyncSession, author: models.user.User, title: str, description: Optional[str], body: Optional[str], tag_list: Optional[List[str]]):
    slug = slugify(title)
...
async def add_comment(db: AsyncSession, article: models.article.Article, author: models.user.User, body: str):
